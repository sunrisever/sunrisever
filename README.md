...
| Project | Focus |
| --- | --- |
| [Fries](https://github.com/sunrisever/fries) | Desktop console for AI subscription windows, account routing, timeline logs, token analytics, and multi-platform releases |
